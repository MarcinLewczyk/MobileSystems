...
public class ItemInboundActivity extends AppCompatActivity {
        ...
        cameraPreview.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(ItemInboundActivity.this, new String[]{android.Manifest.permission.CAMERA}, RequestCameraPermissionID);
                    return;
                }
                try {
    ...
    private class ItemInfoWebServiceHandler extends AsyncTask<String, Void, String>{
        ...
        private ProgressDialog dialog = new ProgressDialog(ItemInboundActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                new AlertDialog.Builder(ItemInboundActivity.this)
                        .setTitle("Error")
